        ...
        <div class="modal-body">
          <div class="content-confirm" v-if="isChange">
            ...
            <div class="content-info">
              <p>
                <span class="label">アカウント氏名</span>： {{ educationalStaff.name }}
                <span v-if="educationalStaff.name_kana">（ {{educationalStaff.name_kana}} ）</span>
              </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions('educationStaff', ['changeOwnerRole']),
      checkOwner(role) {
